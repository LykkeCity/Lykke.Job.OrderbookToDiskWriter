...
using Lykke.Job.OrderbookToDiskWriter.Modules;
using Lykke.Logs;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "OrderbookToDiskWriter API");
                });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime appLifetime)
        {
            try
            {
                ...
                app.UseLykkeMiddleware("OrderbookToDiskWriter", ex => new ErrorResponse {ErrorMessage = "Technical problem"});
